...
async def call5rp0(call: CallbackQuery):
...
async def call5rp1(call: CallbackQuery):
    await call.bot.delete_message(message_id=call.message.message_id, chat_id=call.message.chat.id)
    a = await call.bot.send_message(chat_id=call.from_user.id, text=f'- Process')
...
async def call5rp3(call: CallbackQuery):
    await call.bot.delete_message(message_id=call.message.message_id, chat_id=call.message.chat.id)
    a = await call.bot.send_message(chat_id=call.from_user.id, text=f'- Process')
...
async def call5rp2(call: CallbackQuery):
    await call.bot.delete_message(message_id=call.message.message_id, chat_id=call.message.chat.id)
    a = await call.bot.send_message(chat_id=call.from_user.id, text=f'- Process')
    api_url = ''
    api_clear_url = ''
    ...
    res = requests.post(api_clear_url, data='', headers=headers)
